...
def c1(video_full_path, output_file_name, target_size):
...
def c2(video_full_path, size_upper_bound, two_pass=True, filename_suffix='1'):
    """
    ...
    try:
        ...
        if os.path.getsize(output_file_name) <= size_upper_bound * 1024:
            ...
            return c2(output_file_name, size_upper_bound)
        else:
            return False
...
reduced_size = int(compress_factor * file_size)
c1(in_file, out_file, best_min_size)

file_name = c2('input.mp4', 50 * 1000)
print(file_name)
'''
